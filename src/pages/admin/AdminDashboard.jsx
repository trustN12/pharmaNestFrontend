...
function AdminDashboard() {
  ...
  const fetchAdminDetails = async () => {
    try {
      const response = await axios.get(`${API}/api/Admin/GetAdminProfile`);
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(`${API}/api/Admin/GetUsers`);
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.post(`${API}/api/Medicines/OrderList`, {
        id: 0,
        type: "Admin",
      });
  ...
  const fetchMedicines = async () => {
    try {
      const response = await axios.get(`${API}/api/Medicines/MedicineList`);
        ...
        <div className="relative z-10 p-4 md:p-8">
          ...
          <div className="flex flex-col xl:flex-row justify-between gap-8 mb-14">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-400 text-lg mt-6 max-w-2xl leading-8">
                Realtime monitoring of medicines, users, pharmacy orders and
                analytics inside PharmaNest Admin Dashboard.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              >
                ...
                <h2 className="text-slate-400 text-lg">{item.title}</h2>

                <h1 className="text-5xl font-black mt-3">{item.value}</h1>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[35px] p-8 backdrop-blur-3xl">
              <h2 className="text-3xl font-black mb-10">System Analytics</h2>
            ...
            <div className="bg-white/5 border border-white/10 rounded-[35px] p-8 backdrop-blur-3xl">
              <h2 className="text-3xl font-black mb-10">Database Growth</h2>
